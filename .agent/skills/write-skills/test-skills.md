...
**Why this works:** See `persuasion.md` (in `write-skills` directory) for research on how authority, scarcity, and commitment principles increase compliance pressure.
